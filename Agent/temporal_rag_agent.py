...
You are assisting a quantitative research study that uses a Bayesian Multi-Task Graph \
Neural Network (B-MTGNN) to forecast stock performance of major AI/IT companies.
...
deliver a qualitative explanation for the B-MTGNN model's quantitative predictions.

RESPONSE REQUIREMENTS:
1. Ground every claim in the context (cite by [Doc N] or publication date)
2. Use the relational paths as causal reasoning chains
...
5. Use rigorous academic language suitable for a top-tier IS/Finance journal
...
"""
    ...
    def reason(
        ...
        """
        print(f"\n{'='*65}")
        print(f"  [Temporal PathRAG Agent] 추론 시작")
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Temporal PathRAG Agent — B-MTGNN 예측 근거 설명"
    )
    ...
    print(f"\n{'='*65}")
    print("  [Temporal PathRAG Agent] 추론 완료")
    print(f"{'='*65}")
